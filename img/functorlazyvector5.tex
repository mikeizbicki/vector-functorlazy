...
\node[minimum size=1cm,draw,fill=lightgreen] at (0,1.2) {2};
\node[minimum size=1cm,draw] at (1,1.2) {1};
\node[minimum size=1cm,draw,fill=lightgreen] at (2,1.2) {2};
...
\node[minimum size=1cm,draw,fill=lightgreen] (a) at (-0.2,-2.3) {-54};
\node[minimum size=1cm,draw] (b) at (0.9,-1.5) {-8.4};
\node[minimum size=1cm,draw,fill=lightgreen] (b2) at (1.5,-3.5) {-15.4};
