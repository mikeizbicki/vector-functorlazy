...
%\node at (2.1,3) {:};
%\node at (2.8,3) {$[\ ]$};
\node[minimum width=2.5cm,align=right] at (-1.5,0) {\Large \emph{vecAny}};
\node[minimum width=2.5cm,align=right] at (-1.5,1.2) {\Large \emph{vecInt}};
\node[minimum width=2.5cm,align=right] at (-1.65,3) {\Large \emph{funcList}};

\node[minimum width=10cm,minimum height=1cm,draw] at (4.5,3) {$[\ ]$};
